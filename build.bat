...
set FLAGS=-O2 -EHsc -WX -W4 -wd4201 -wd4189 -wd4100 -wd4127 -wd4189 -wd4505 -wd4996 -FC -Z7 -nologo
set LINKER_FLAGS=/opt:ref /subsystem:windows
set LIBS=gdi32.lib gdiplus.lib kernel32.lib shell32.lib user32.lib comdlg32.lib
